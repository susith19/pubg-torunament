...
const XSmallIcon = () => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
    <path d="M3.5 3.5l7 7M10.5 3.5l-7 7" stroke="#dc2626" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="flex items-center justify-center gap-3">
          <span className="text-gray-500 text-base sm:text-lg font-light">Create account on</span>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
                ...
                {rules.map((rule) => {
                  ...
                  return (
                    <div key={rule.label} className="flex items-center gap-2">
                      <span className={`flex-shrink-0 ${passed ? "text-green-600" : "text-red-500"}`}>
          ...
          <div className="mb-5">
            ...
            <div className="relative">
              <input
                ...
                onKeyDown={handleKeyDown}
                autoComplete="new-password"
                className={`w-full px-4 py-3 pr-12 rounded-xl bg-white border text-gray-900 text-sm placeholder-gray-400 outline-none transition-all duration-150 ${confirmPassword.length > 0
                  ? passwordsMatch
          ...
          <div className="flex items-start gap-3 mb-6">
            <div
              className={`mt-0.5 w-4 h-4 flex-shrink-0 rounded border flex items-center justify-center transition-all duration-150 cursor-pointer ${agreed ? "bg-[#F2AA00] border-[#F2AA00]" : "bg-white border-gray-300"
                }`}
            ...
            >
              I agree to the{" "}
              <a href="#" onClick={(e) => e.stopPropagation()} className="text-gray-900 font-medium underline underline-offset-2 decoration-gray-300 hover:text-[#F2AA00] transition-colors">
                Terms of Service
              </a>{" "}
              and{" "}
              <a href="#" onClick={(e) => e.stopPropagation()} className="text-gray-900 font-medium underline underline-offset-2 decoration-gray-300 hover:text-[#F2AA00] transition-colors">
