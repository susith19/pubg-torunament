...
const navItems = [
  ...
  { label: "SCHEDULE", href: "/schedule" },
  {
    ...
    dropdown: [
      ...
      { label: "Rankings", href: "/teams/rankings" },
      { label: "Statistics", href: "/teams/stats" },
    ],
  },
...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 w-full bg-[#F2AA00] flex items-center justify-between px-8 py-0 relative" style={{ minHeight: 56 }}>
