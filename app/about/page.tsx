...
const TEAM = [
  {
    ...
    socials: [
      {
        icon: faInstagram,
        label: "Instagram",
        href: "https://www.instagram.com/ashwin_jenifa",
        color:
          "text-pink-400 border-pink-500/20 bg-pink-500/5 hover:bg-pink-500/10 hover:border-pink-500/30",
      },
      {
        icon: faYoutube,
        label: "YouTube",
        href: "https://youtube.com/@kingopislive-pubg",
        color:
    ...
    contacts: [
      {
        label: "India",
        value: "+91 75399 93019",
        href: "tel:+917539993019",
        flag: "🇮🇳",
        wa: "https://wa.me/917539993019",
      },
      {
        label: "Dubai",
        value: "+971 504211486",
    ...
    socials: [
      {
        icon: faInstagram,
        label: "Instagram",
        href: "https://www.instagram.com/Titus_Viju",
        color:
          "text-pink-400 border-pink-500/20 bg-pink-500/5 hover:bg-pink-500/10 hover:border-pink-500/30",
      },
    ],
    contacts: [
      {
        label: "India",
        value: "+91 7418270710",
        href: "tel:+917418270710",
        flag: "🇮🇳",
        wa: "https://wa.me/917418270710",
      },
      {
        label: "Dubai",
        value: "+971 588340270",
        href: "tel:+971588340270",
        flag: "🇦🇪",
        wa: "https://wa.me/971588340270",
      },
    ],
  },
];
...
const VALUES = [
  {
    icon: faShield,
    title: "Fair Play",
    desc: "Zero tolerance for hacks, cheats, or unsportsmanlike conduct. Every match is monitored.",
  },
  {
    icon: faTrophy,
    title: "Real Rewards",
    desc: "Prize pools distributed transparently. Top players earn what they deserve.",
  },
  {
    icon: faUsers,
    title: "Community First",
    desc: "Built by gamers, for gamers. Your feedback shapes every feature and decision.",
  },
  {
    icon: faGamepad,
    title: "Multi-Platform",
    desc: "PUBG PC & BGMI Mobile — we support the full battle royale ecosystem.",
  },
];
...
const FAQS = [
  ...
  {
    q: "What happens if I face technical issues?",
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          <span className="text-[#F2AA00]/50 text-md font-mono tracking-widest">
            0{index + 1}
          </span>
        ...
        <FontAwesomeIcon
          icon={faChevronDown}
          className={`text-[#F2AA00] text-md flex-shrink-0 transition-transform duration-300 ${open ? "rotate-180" : ""}`}
        />
      </button>
      <div
        className={`overflow-hidden transition-all duration-300 ${open ? "max-h-48 opacity-100" : "max-h-0 opacity-0"}`}
      >
        <p className="px-6 pb-5 text-gray-400 text-md leading-relaxed border-t border-gray-800/60 pt-4">
          {a}
        </p>
      </div>
    </div>
...
export default function AboutPage() {
  ...
  useEffect(() => {
    ...
    fetch("/api/about/stats")
      .then((r) => r.json())
      .then((d) => setDbStats(d))
      .catch(() => {}); // fail silently — "…" shown as fallback
  }, []);

  // First two cards use live numbers; last two are always static
  const STATS = [
    {
      value: dbStats ? `${dbStats.tournaments.toLocaleString("en-IN")}+` : "…",
      label: "Tournaments Hosted",
      icon: faTrophy,
      live: true,
    },
    {
      value: dbStats ? `${dbStats.players.toLocaleString("en-IN")}+` : "…",
      label: "Registered Players",
      icon: faUsers,
      live: true,
    },
    { value: "2", label: "Countries", icon: faGlobe, live: false },
    { value: "24/7", label: "Support", icon: faHeadset, live: false },
  ];
    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="relative py-28 px-6 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(#F2AA00 1px, transparent 1px), linear-gradient(90deg, #F2AA00 1px, transparent 1px)",
        ...
        <div
          className={`relative z-10 max-w-4xl mx-auto text-center transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          <div className="inline-flex items-center gap-2 border border-[#F2AA00]/30 bg-[#F2AA00]/5 px-4 py-1.5 rounded-full mb-6">
            ...
            />
            <span className="text-[#F2AA00] text-[10px] tracking-[0.3em] uppercase">
              Built by Gamers. Made for Champions.
            </span>
          </div>
          ...
          <p className="text-gray-400 text-base leading-relaxed max-w-2xl mx-auto tracking-wide">
            South Asia & UAE's premier PUBG & BGMI tournament platform — built
            to give every player, from bedroom warrior to pro contender, a fair,
            exciting, and rewarding competitive experience.
          </p>
        </div>
      </section>

      {/* STATS — first two are live from DB */}
          ...
          {STATS.map((s, i) => (
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-[#F2AA00]/10 flex items-center justify-center mx-auto mb-3 group-hover:bg-[#F2AA00]/20 transition-colors">
                <FontAwesomeIcon
                  icon={s.icon}
                  className="text-[#F2AA00] text-md"
                />
              </div>
              {/* Show pulse skeleton while live data loads */}
              <p
                className={`text-3xl font-bold tracking-wider ${s.live && !dbStats ? "text-gray-700 animate-pulse" : "text-white"}`}
              >
                {s.value}
              </p>
              <p className="text-gray-500 text-[12px] tracking-widest mt-1 uppercase">
                {s.label}
              </p>
            </div>
          ))}
      ...
      <section className="px-6 py-16 bg-[#080808]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#F2AA00]/60 text-md tracking-[0.4em] uppercase mb-3">
              The Platform
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div>
              <p className="text-gray-400 text-md leading-relaxed mb-4">
                This platform is built for players who love the thrill of the
                drop, the fight for survival, and the glory of victory.
              </p>
              <p className="text-gray-400 text-md leading-relaxed mb-6">
                We host organized PUBG & BGMI tournaments, provide transparent
                results, and give players the chance to compete, earn rewards,
                and make their mark in esports.
              </p>
              <div className="space-y-3">
                <div className="flex items-center gap-3 bg-[#0b0b0b] border border-[#F2AA00]/20 rounded-xl px-5 py-3">
                  ...
                  <span className="text-white text-md tracking-wide">
                    "Drop In. Fight Hard. Become a Champion."
                  </span>
                </div>
                <div className="flex items-center gap-3 bg-[#0b0b0b] border border-[#F2AA00]/20 rounded-xl px-5 py-3">
                  <FontAwesomeIcon
                    icon={faGamepad}
                    className="text-[#F2AA00]"
                  />
                  <span className="text-white text-md tracking-wide">
            ...
            <div className="grid grid-cols-2 gap-3">
              {VALUES.map((v, i) => (
                <div
                  key={i}
                  className="bg-[#0b0b0b] border border-gray-800 rounded-xl p-5 hover:border-[#F2AA00]/30 hover:-translate-y-1 transition-all duration-300"
                >
                  ...
                  <p className="text-white text-md tracking-wide mb-1">
                    {v.title}
                  </p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="relative bg-[#0b0b0b] border border-[#F2AA00]/20 rounded-2xl p-8 overflow-hidden group hover:border-[#F2AA00]/40 hover:shadow-[0_0_30px_rgba(242,170,0,0.08)] transition-all duration-300">
            ...
            <div className="w-12 h-12 rounded-xl bg-[#F2AA00]/10 flex items-center justify-center mb-5 group-hover:bg-[#F2AA00]/20 transition-colors">
              <FontAwesomeIcon
                icon={faBullseye}
                className="text-[#F2AA00] text-xl"
              />
            </div>
            <p className="text-[#F2AA00]/60 text-[10px] tracking-[0.4em] uppercase mb-2">
              Our Mission
            </p>
            <h3 className="text-white text-xl tracking-wide mb-3">
              "Give every player a real chance to win."
            </h3>
            <p className="text-gray-400 text-md leading-relaxed">
              We aim to create a trusted competitive platform for PUBG players
              by hosting fair tournaments, exciting matches, and real rewards —
              where skill, teamwork, and strategy decide the champions.
            </p>
          </div>
          <div className="relative bg-[#0b0b0b] border border-purple-500/20 rounded-2xl p-8 overflow-hidden group hover:border-purple-500/40 hover:shadow-[0_0_30px_rgba(168,85,247,0.08)] transition-all duration-300">
            ...
            <p className="text-purple-400/60 text-[10px] tracking-[0.4em] uppercase mb-2">
              Our Vision
            </p>
            <h3 className="text-white text-xl tracking-wide mb-3">
            ...
            <p className="text-gray-400 text-md leading-relaxed">
              To become a global esports platform where gamers connect, compete,
              and rise as legends — a community that celebrates skill,
              dedication, and the spirit of competition.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-16 bg-[#080808]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-md mt-3 italic">
              "Built by gamers. Made for champions."
            </p>
            <div className="w-12 h-0.5 bg-[#F2AA00] mx-auto mt-4" />
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {TEAM.map((member, i) => (
              <div
                key={i}
                className="group bg-[#0b0b0b] border border-gray-800 rounded-2xl p-7 hover:border-[#F2AA00]/30 hover:shadow-[0_0_30px_rgba(242,170,0,0.07)] transition-all duration-300"
              >
                <div className="flex items-center gap-4 mb-5">
                  <div
                    className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${member.color} ring-2 ${member.ring} flex items-center justify-center text-black font-bold text-xl flex-shrink-0 overflow-hidden relative`}
                  >
                  ...
                  {member.contacts.map((c, j) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white text-md tracking-wide group-hover/link:text-[#F2AA00] transition-colors">
                          {c.value}
                        </p>
                      </div>
                      <FontAwesomeIcon
                        icon={faPhone}
                        className="text-gray-700 text-md group-hover/link:text-[#F2AA00] transition-colors"
                      />
                    </a>
                  ))}
                </div>
                <a
                  href={member.contacts[0].wa}
                  target="_blank"
                  rel="noreferrer"
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-md mt-3 max-w-xl mx-auto">
            Have a question, dispute, or just want to say hi? We're reachable
          ...
          {[
            {
              ...
              icon: faEnvelope,
              iconCls: "text-[#F2AA00]",
              borderCls: "border-gray-800 hover:border-[#F2AA00]/40",
              bgCls: "",
              label: "Email Support",
              value: "kingopubgtournaments@gmail.com",
            ...
            },
            {
              ...
              bgCls: "bg-red-500/10",
              label: "YouTube",
              value: "@kingopislive-pubg",
              sub: "Live streams · Match replays · Highlights",
            },
            {
              href: "https://www.instagram.com/kingpubg_tournaments.co",
              icon: faInstagram,
              ...
              label: "Instagram",
              value: "@kingpubg_tournaments.co",
              sub: "Winners · Announcements · Updates",
            },
            {
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className={`group flex flex-col gap-4 bg-[#0b0b0b] border rounded-2xl p-6 hover:-translate-y-1 transition-all duration-300 ${c.borderCls}`}
            >
              <div
                className={`w-12 h-12 rounded-xl flex items-center justify-center group-hover:opacity-80 transition-colors ${c.bgCls || "bg-[#F2AA00]/10"}`}
              >
                <FontAwesomeIcon
                  icon={c.icon}
                  className={`text-xl ${c.iconCls}`}
                />
              </div>
              <div>
                ...
                <p className="text-white text-md tracking-wide break-all">
                  {c.value}
                </p>
                <p className="text-gray-600 text-[12px] mt-2">{c.sub}</p>
              </div>
            </a>
          ))}
        </div>
          ...
          {[
            {
              ...
              sub: "Serving players across all Indian states · BGMI & PUBG",
            },
            {
              flag: "🇦🇪",
              region: "UAE",
              title: "Dubai, United Arab Emirates",
              sub: "Serving UAE & GCC region players · PUBG",
            },
          ].map((r) => (
            <div
              key={r.region}
              className="bg-[#0b0b0b] border border-gray-800 rounded-2xl p-6 flex items-start gap-4"
            >
              <div className="w-10 h-10 rounded-lg bg-[#F2AA00]/10 flex items-center justify-center flex-shrink-0 text-base">
                {r.flag}
              </div>
              <div>
                <p className="text-[10px] text-gray-600 tracking-widest uppercase mb-1">
                ...
                <p className="text-white text-md tracking-wide">{r.title}</p>
                <p className="text-gray-500 text-md mt-1">{r.sub}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="relative px-6 py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          <h2 className="text-4xl tracking-widest mb-4">
            Ready to <span className="text-[#F2AA00]">Compete?</span>
          </h2>
          <p className="text-gray-500 text-md mb-8 tracking-wide">
            Join thousands of players battling it out across India and UAE.
            Register free and start winning.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/tournaments"
              className="bg-[#F2AA00] text-black px-8 py-3.5 text-md tracking-widest hover:bg-[#e09e00] hover:shadow-lg hover:shadow-[#F2AA00]/20 active:scale-95 transition-all duration-150 rounded-lg"
            >
              Browse Tournaments
            </Link>
            <Link
              href="/signup"
              className="border border-gray-700 text-gray-300 px-8 py-3.5 text-md tracking-widest hover:border-[#F2AA00]/50 hover:text-[#F2AA00] transition-all duration-200 rounded-lg"
            >
              Create Account
            </Link>
          </div>
